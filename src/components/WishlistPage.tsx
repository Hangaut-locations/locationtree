  ...
  return (
    <div className="mx-auto max-w-7xl px-4 md:px-8 py-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-black text-foreground tracking-tight">Wish / Loved list</h1>
      </div>
      ...
      {saved.length === 0 ? (
        <div className="rounded-3xl border border-dashed border-border bg-card p-14 text-center">
          ...
          <p className="text-base font-black text-foreground">Your wishlist is empty</p>
