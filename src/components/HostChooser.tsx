  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      <header className="sticky top-0 z-40 w-full border-b border-border bg-background/95 backdrop-blur-md px-4 py-4 md:px-8 flex items-center gap-3">
        <button
          onClick={onBack}
          className="flex items-center gap-1.5 rounded-full border border-border px-4 py-2 text-sm font-semibold text-foreground hover:bg-muted transition-all cursor-pointer"
        >
      ...
      <main className="grow flex items-center justify-center px-4 md:px-8 py-12">
        <div className="w-full max-w-4xl mx-auto space-y-10 animate-in fade-in fade-in-20 duration-300">
          <div className="text-center space-y-3">
            <span className="inline-block text-xs font-semibold uppercase tracking-widest text-purple-950 dark:text-purple-300">
              Become a Host
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="mt-5 flex items-center gap-2 text-xs font-medium text-purple-950 dark:text-purple-300">
