...
export const HostChooser: React.FC<HostChooserProps> = ({ onBack, onParty, onProperty }) => {
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      <header className="sticky top-0 z-40 w-full border-b border-border bg-background/95 backdrop-blur-md px-4 py-4 md:px-8 flex items-center gap-3">
        <button
          onClick={onBack}
          className="flex items-center gap-1.5 rounded-full border border-border px-4 py-2 text-sm font-black text-foreground hover:bg-muted transition-all cursor-pointer"
        >
      ...
      <main className="grow flex items-center justify-center px-4 md:px-8 py-12">
        <div className="w-full max-w-4xl mx-auto space-y-10 animate-in fade-in fade-in-20 duration-300">
          <div className="text-center space-y-3">
            <span className="inline-block text-xs font-black uppercase tracking-widest text-purple-950 dark:text-purple-300">
              Become a Host
            </span>
            ...
            <p className="text-base font-semibold text-muted-foreground max-w-xl mx-auto">
              Choose how you want to earn with Hangout. Hosting a party and listing a property each collect different
              information.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <h2 className="text-xl font-black text-foreground tracking-tight">Host a party</h2>
              <p className="mt-2 text-sm font-semibold text-muted-foreground leading-relaxed">
                Whether it's a beach party, yacht gathering, live show or birthday — share your event, sell tickets, and
                get guests to book in. Set your dates, pictures, rules and price per person or hour.
              </p>
              <div className="mt-5 flex items-center gap-2 text-xs font-black text-purple-950 dark:text-purple-300">
            ...
            >
              ...
              <h2 className="text-xl font-black text-foreground tracking-tight">List a property</h2>
              <p className="mt-2 text-sm font-semibold text-muted-foreground leading-relaxed">
                List your space to be used as a location or spot for events and parties. With Hangout you get extended
                reach that leads to diverse guests and more opportunities for your business.
              </p>
              <div className="mt-5 flex items-center gap-2 text-xs font-black text-purple-950 dark:text-purple-300">
