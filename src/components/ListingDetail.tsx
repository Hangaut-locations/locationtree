  ...
  return (
    <div className="mx-auto max-w-7xl px-4 md:px-8 py-8 transition-colors duration-300">
      ...
      <div className="flex items-center justify-between mb-6">
        <button
          onClick={onBack}
          className="flex items-center gap-2 text-sm font-bold text-foreground hover:text-purple-950 dark:hover:text-purple-300 transition-colors cursor-pointer group"
        >
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-1.5 rounded-full border border-border px-4 py-2.5 md:py-2 text-xs md:text-sm font-bold text-foreground hover:bg-muted transition-all cursor-pointer">
      ...
      <div className="flex items-center gap-3 border-b border-border/60 pb-4 mb-8">
        <button
          ...
          className={`py-2.5 md:py-2 px-5 rounded-full text-sm font-bold transition-all cursor-pointer ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12 mb-16">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="space-y-3">
            <h3 className="text-base font-bold text-foreground">TT</h3>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm font-semibold text-muted-foreground leading-relaxed">
              This is a penthouse in the Queen of The Isle Apartments. The flat
              benefits from 2 outdoor spaces: a large balcony and a separate
              terrace for those who like to relax in the evening.
            </p>
            <p className="text-sm font-semibold text-muted-foreground leading-relaxed">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-[32px] border border-border bg-card p-6 shadow-md space-y-4">
            ...
            {dateRange?.from && dateRange?.to && (
              <div className="space-y-2 pt-2 text-xs font-bold text-muted-foreground">
                ...
                <div className="flex justify-between text-foreground text-sm font-bold border-t border-border/60 pt-2">
                  <span>Total</span>
                  <span>{formattedTotal}</span>
                </div>
              </div>
          ...
          <div className="rounded-[32px] border border-border bg-card p-6 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-7 gap-y-1.5 text-center text-[10px] font-bold">
      ...
      <div id="facilities" className="border-t border-border/60 pt-10 mb-12">
        <span className="inline-block bg-purple-950 text-white dark:bg-purple-800 rounded-full px-4 py-1.5 text-xs font-bold mb-4">
          Facilities
        </span>
        ...
        <button className="rounded-full border border-border px-5 py-2.5 text-sm font-bold text-foreground hover:bg-muted transition-colors cursor-pointer">
          Show all amenities
        </button>
      </div>
